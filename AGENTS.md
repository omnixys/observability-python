...
Omnixys shared observability package (OTel tracing, structured logging, Prometheus metrics).

- Repository path: `packages/python/observability` (relative to the Omnixys root)
...
Logging helpers must not leak sensitive payloads.
